...
const xpImg = "https://mgg.autos/images/misc/xpadd"; // Cambiado de xp a xpadd
const xpPercent = [10, 40, 80, 120, 150, 200, 300, 0];

// Llenar los dropdowns con las nuevas imágenes
for (let d = 1; d < 4; d++) {
    for (let i = 0; i < 8; i++) {
        const elem = document.createElement("img");
        elem.setAttribute("src", xpImg + i + '.png'); // Asegúrate de que los nombres de archivos coincidan
